...
namespace MeuBasico
{
    ...
    {
        public static string _connectionString = "isostore:/Mercado.sdf";

        private static ProdutoView _viewProduto;
        public static ProdutoView ViewProduto
        {
            get
            {
                if (_viewProduto == null)
                    _viewProduto = new ProdutoView();

                return App._viewProduto;
            }
        }
